...
Input
-----
  All GeoJSON files in data/masks/raw/ matching:
...
Usage
-----
  docker compose exec segmentation python scripts/summarize_masks.py
  docker compose exec segmentation python scripts/summarize_masks.py --include-donut --output /app/data/masks/merged
"""
...
# Configuration
# ---------------------------------------------------------------------------
DEFAULT_RAW_DIR = Path("/app/data/masks/raw")
DEFAULT_OUTPUT_DIR = Path("/app/data/masks/merged")
